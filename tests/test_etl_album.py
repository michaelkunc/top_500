...
class Album_Test(unittest.TestCase):
    ...
    #         (int(Album_Test.data.df['Year'].min()), int(Album_Test.data.df['
    ...
    def test_normalize_genre_ampersand(self):
        self.assertEqual('Folk,World,Country', Album_Test.data.normalize_genre()[
                         'normalized_genre'].iloc[476])

    def test_normalize_genre_slash(self):
        self.assertEqual('Hip Hop,Funk,Soul', Album_Test.data.normalize_genre()[
                         'normalized_genre'].iloc[480])

    def test_normalize_genre_extra_space(self):
        self.assertEqual('Rock,Blues', Album_Test.data.normalize_genre()[

...
class SongTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        SongTest.lfm = songs.Artists(500)

    def test_top_artist(self):
        self.assertEqual(
            {'664c3e0e-42d8-48c1-b209-1efca19c0325': ['The National', '780']}, SongTest.lfm.artists_playcounts[0])

    def test_150th_artist(self):
        self.assertEqual(
            {'fc7bbf00-fbaa-4736-986b-b3ac0266ca9b': ['alt-J', '68']}, SongTest.lfm.artists_playcounts[150])
